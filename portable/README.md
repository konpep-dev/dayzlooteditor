...
Το **DayZ Types Editor** είναι ένα εύκολο και πλήρες εργαλείο επεξεργασίας του αρχείου `types.xml` του DayZ (loot configuration). Διαθέτει σκούρο θέμα, αναζήτηση και φιλτράρισμα, μαζική επεξεργασία, undo/redo, και αυτόματες εφεδρικές αντιγραφές (backups). Είναι portable — δεν χρειάζεται εγκατάσταση.
